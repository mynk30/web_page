...
try {
    ...
    if (!empty($searchQuery)) {
        $query .= " AND (a.application_number LIKE ? OR a.service_type LIKE ? OR a.name LIKE ?)";
    ...
    $countQuery = "SELECT COUNT(*) FROM (" . str_replace('a.*, (SELECT COUNT(*)', 'a.id', $query) . ") as count_table";
...
// Include sidebar after processing to avoid header issues
include 'sidebar.php';
?>
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="search" name="search" 
                               ...
                               placeholder="Search by application #, service type, or name">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-secondary">
                                            <?php echo (int)$app['document_count']; ?> uploaded
                                        </span>
                                    </td>
                                    <td>
                                        ...
                                        <?php if (in_array(strtolower($app['status']), ['pending', 'missing_document'])): ?>
